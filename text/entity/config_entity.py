...
class DataTransformationConfig: 
    def __init__(self): 
        ...
        self.PATH_TOKENIZED_DATA = os.path.join(os.getcwd(),ARTIFACTS_DIR,DATA_TRANSFORMATION_ARTIFACTS_DIR + '/')
...
class ModelEvaluationConfig:
    def __init__(self):
        self.EVALUATED_MODEL_DIR: str = os.path.join(os.getcwd(), ARTIFACTS_DIR, MODEL_EVALUATION_ARTIFACTS_DIR)
